...
function useAppState() {
    ...
    const setWatermarkStyles = (0, __TURBOPACK__imported__module__$5b$project$5d2f$anicode$2f$flagvault$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useAppState.useCallback[setWatermarkStyles]": (styles)=>setState({
                "useAppState.useCallback[setWatermarkStyles]": (s)=>({
                        ...s,
                        watermark: {
                            ...s.watermark,
                            styles
            ...
            }["useAppState.useCallback[setWatermarkStyles]"])
    }["useAppState.useCallback[setWatermarkStyles]"], []);
    ...
    const setFlatten = (0, __TURBOPACK__imported__module__$5b$project$5d2f$anicode$2f$flagvault$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useAppState.useCallback[setFlatten]": (flatten)=>setState({
                "useAppState.useCallback[setFlatten]": (s)=>({
                        ...s,
                        redact: {
                            ...s.redact,
                            flatten
            ...
            }["useAppState.useCallback[setFlatten]"])
    }["useAppState.useCallback[setFlatten]"], []);
...
_s(useAppState, "jFpoq6oFS55VTgVsqhrhpYLUXfk=");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
            ...
            !file && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$anicode$2f$flagvault$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$anicode$2f$flagvault$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$anicode$2f$flagvault$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("strong", {
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$anicode$2f$flagvault$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("a", {
...
function StepWatermark({ watermark, stegOptions, forensicId, forensicTs, onWatermark, onStyleChange, onStegToggle, onRegenId, onNext, onBack }) {
    _s();
    const { state } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$anicode$2f$flagvault$2f$hooks$2f$useAppState$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAppState"])();
    const previewText = buildPreviewText(watermark);
    // Live preview canvas state
    const canvasRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$anicode$2f$flagvault$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    const [previewLoading, setPreviewLoading] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$anicode$2f$flagvault$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    const [copiedId, setCopiedId] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$anicode$2f$flagvault$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    // Multi-select logic
    ...
    const copyId = (0, __TURBOPACK__imported__module__$5b$project$5d2f$anicode$2f$flagvault$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "StepWatermark.useCallback[copyId]": ()=>{
            navigator.clipboard.writeText(forensicId);
            setCopiedId(true);
            setTimeout({
                "StepWatermark.useCallback[copyId]": ()=>setCopiedId(false)
            }["StepWatermark.useCallback[copyId]"], 2000);
        }
    }["StepWatermark.useCallback[copyId]"], [
        forensicId
    ]);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$anicode$2f$flagvault$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "StepWatermark.useEffect": ()=>{
            if (!state.fileBytes || !canvasRef.current) return;
            let isStale = false;
            const renderPreview = {
                "StepWatermark.useEffect.renderPreview": async ()=>{
                    setPreviewLoading(true);
                    try {
                        const { getDocument, GlobalWorkerOptions } = await __turbopack_context__.A("[project]/anicode/flagvault/node_modules/pdfjs-dist/build/pdf.mjs [app-client] (ecmascript, async loader)");
            ...
            }["StepWatermark.useEffect.renderPreview"];
            renderPreview();
            return ({
                "StepWatermark.useEffect": ()=>{
                    isStale = true;
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$anicode$2f$flagvault$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$anicode$2f$flagvault$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    previewLoading && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$anicode$2f$flagvault$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$anicode$2f$flagvault$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("canvas", {
                                        ref: canvasRef,
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$anicode$2f$flagvault$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                        ...
                                        if (style === "grid") {
                                            return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$anicode$2f$flagvault$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: [
                                                    ...
                                                    3,
                                                    4
                                                ].map((i)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$anicode$2f$flagvault$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    watermark.styles.some((s)=>s.includes("qr")) && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$anicode$2f$flagvault$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(StepWatermark, "pjDv435CFgaOuA4YgyRwculBe+o=", false, function() {
    return [
        ...
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$anicode$2f$flagvault$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    hasRedaction && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$anicode$2f$flagvault$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
"[project]/anicode/flagvault/lib/flatten.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/anicode/flagvault/lib/redact.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function rasterizeAndRedact(pdfBytes, config, onProgress) {
    ...
    const [{ getDocument, GlobalWorkerOptions }, { PDFDocument }] = await Promise.all([
        __turbopack_context__.A("[project]/anicode/flagvault/node_modules/pdfjs-dist/build/pdf.mjs [app-client] (ecmascript, async loader)"),
        __turbopack_context__.A("[project]/anicode/flagvault/node_modules/pdf-lib/es/index.js [app-client] (ecmascript, async loader)")
    ]);
...
var __TURBOPACK__imported__module__$5b$project$5d2f$anicode$2f$flagvault$2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/anicode/flagvault/lib/utils.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$anicode$2f$flagvault$2f$lib$2f$flatten$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/anicode/flagvault/lib/flatten.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$anicode$2f$flagvault$2f$lib$2f$redact$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/anicode/flagvault/lib/redact.ts [app-client] (ecmascript)");
;
;
;
;
...
async function processDocument({ fileBytes, fileName, fileType, watermark, redact, steg, forensicId, onProgress }) {
    ...
    if (redact.flatten) {
        ...
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$anicode$2f$flagvault$2f$lib$2f$flatten$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["flattenPdf"])(pdfDoc);
    }
    ...
    if (hasRedaction) {
        pdfBytes = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$anicode$2f$flagvault$2f$lib$2f$redact$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["rasterizeAndRedact"])(pdfBytes, redact, (pct, label)=>{
...
function WatermarkApp() {
    _s();
    const { state, setStep, setFile, setWatermark, setWatermarkStyles, toggleRedactCategory, setCustomTerms, setFlatten, toggleStegOption, regenForensicId, setProgress, setOutput, setError, reset } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$anicode$2f$flagvault$2f$hooks$2f$useAppState$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAppState"])();
...
_s(WatermarkApp, "5QKeEua1cahLH8efz5hXprUsslM=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$anicode$2f$flagvault$2f$hooks$2f$useAppState$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAppState"]
    ];
});
...
//# sourceMappingURL=anicode_flagvault_cf6142b6._.js.map